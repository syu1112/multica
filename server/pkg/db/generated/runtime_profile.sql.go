...
func (q *Queries) CountAgentsByProfile(ctx context.Context, runtimeProfileID pgtype.UUID) (int64, error) {
	row := q.db.QueryRow(ctx, countAgentsByProfile, runtimeProfileID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
